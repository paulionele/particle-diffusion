...
savepath = '/home/paul/Documents/thesis/particle-diffusion/2D/Final_2D/animation_stills/animation_data_11U/'
filename = 'AFD_t-30k_nU-11_pi-0.05_pe-0.2_pie-0.025.txt'
...
plt.savefig(savepath + 'heterogeneous_11U_2D.pdf')
plt.show()