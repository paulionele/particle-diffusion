...
for filename in files:
  ...
  if '.txt' in filename:
    ...
    if 'MC' or 'FD' in filename:
      ...
      plt.legend(loc=2, title = 'Channel Width')
...
plt.plot(times, 2*0.05*times, color = 'black', linestyle = '--') #lowest intracellular
plt.plot(times, 2*p_total*times, color = 'black', linestyle = '--') #mean transition prob

plt.savefig(savepath + 'ye_msd_2D.pdf')
plt.show()