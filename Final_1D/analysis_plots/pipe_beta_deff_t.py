...
'pipe' data where we plot beta and deff vs. time for varying boundary transition probabilities (pie).
...
savepath = '/home/paul/Documents/thesis/particle-diffusion/Final_1D/analysis_plots/pipe_data/'
...
plt.savefig(savepath + 'pipe_deff_beta_t_1D.pdf')
plt.show()